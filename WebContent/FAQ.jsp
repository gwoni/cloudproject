					...
					<div class="widget-content">
						...
						<div class="faq-toc">
							<ol>
								<li>
									1.
									<a href="#faq-1">How can I get my own domain name?</a>
								</li>
								<li>
									2.
									<a href="#faq-2">How can I block my hosting service's advertisements?</a>
								</li>
								<li>
									3.
									<a href="#faq-3">How do I redirect someone to another page?</a>
								</li>
								<li>
									4.
									<a href="#faq-4">How do I password protect my web site?</a>
								</li>
								<li>
									5.
									<a href="#faq-5">How do I stop my page from being cached?</a>
								</li>
								<li>
									6.
									<a href="#faq-6">How can I disable the browser's right-click options?</a>
								</li>
								<li>
									7.
									<a href="#faq-7">How do I hide my URL?</a>
								</li>
								<li>
									8.
									<a href="#faq-8">How do I detect what browser is being used?</a>
								</li>
								<li>
									9.
									<a href="#faq-9">How do I get my visitors' email addresses?</a>
								</li>
								<li>
									10.
									<a href="#faq-10">Why is my custom 404 Not Found message not displayed?</a>
								</li>
							</ol>
						</div>
						<ol class="faq-list">
...
If you can't set up a redirect, there are other possibilities. These are inferior because they tell the search engines that there's still a page at the old location, not that the page has moved to a new location. But if it's impossible for you to configure redirection at your server, here are two alternatives:</p>
							...
							<li id="faq-4">
								...
								<div class ="faq-text">
									...
									<p>Password protection is done through HTTP authentication. The configuration details vary from server to server, so you should read the authentication section of your server documentation. Contact your server administrator if you need help with this.
...
The Expires header is understood by virtually all caches. The cached document will be retrieved again automatically once it has expired. The Expires header must contain an HTTP date, which must be Greenwich Mean Time (GMT), not local time.</p>
								</div>				
							</li>
							...
							<li id="faq-8">
								...
								<div class ="faq-text">
									...
									<p>Many browsers identify themselves when they request a document. A CGI script will have this information available in the HTTP_USER_AGENT environment variable, and it can use that to send out a version of the document which is optimized for that browser.
...
And of course, if a cache proxy keeps a version intended for one brower, someone with another browser may get that version, rather than the version intended for the other browser.</p>
								</div>				
							</li>
