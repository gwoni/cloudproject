...
<jsp:include page="Header.jsp"  />
 ...
 <div class="container">
  	<form class="form-write" action="process_write.jsp" method="post">
  		<h2 class="form-write-heading">새 글 작성</h2>
  		<input type="text" name=title class="input-block-level" placeholder="새 글 제목">
  		<textarea rows=10 name=content class="input-block-level"></textarea>
  		<button class="btn btn-large btn-primary" type="submit">글 작성</button>
  		<button class="btn btn-large btn-danger" type="cancel">취소</button>
  	</form>
  </div>
